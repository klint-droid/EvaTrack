...
return new class extends Migration
{
    ...
    {
        Schema::connection($this->connection)->create('puroks', function (Blueprint $table) {
            $table->id('purok_id');
            $table->string('purok_name', 100);
            $table->foreignId('sitio_id')->constrained('sitios', 'sitio_id')->onDelete('cascade');
    ...
    {
        Schema::connection($this->connection)->dropIfExists('puroks');
    }
};