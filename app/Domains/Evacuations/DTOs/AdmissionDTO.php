...
class AdmissionDTO
{
    ...
    public static function fromRequest(Request|FormRequest $request, string $centerId, string $userId, string $method = 'manual'): self
    {
        return new self(
            ...
            userId:      $userId,
            method:      $method,
            eventId:     $request->input('event_id') ? (string) $request->input('event_id') : null,
